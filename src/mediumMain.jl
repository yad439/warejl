...
localRes3=modularTabuSearch(TabuSearchSettings(100,10,100),jobs->maxTime(jobs,p,m),randomPermutationEncoding(n))
localRes4=modularTabuSearch(TabuSearchSettings(100,10,100),jobs->maxTime(jobs,p,m),randomTwoVectorEncoding(n,m))
